(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_view_project_activity-log_index_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/project/activity-log/index.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/project/activity-log/index.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      titleCrops: 'Activity Log (Crops)',
      titleCommodities: 'Activity Log (Commodities)',
      titleCustomers: 'Activity Log (Customers)',
      titleDeals: 'Activity Log (Deals)',
      titleDealCommodities: 'Activity Log (Deal Commodities)',
      titleDealExpenses: 'Activity Log (Deal Expenses)',
      titleExpenses: 'Activity Log (Expenses)',
      titleLots: 'Activity Log (Lots)',
      titleTemplates: 'Activity Log (Templates)',
      titleTemplateTypes: 'Activity Log (Template Types)',
      titleUnits: 'Activity Log (Units)',
      titleUsers: 'Activity Log (Users)',
      titleParentCommodities: 'Activity Log (Parent Commodities)',
      show: true,
      searchArrival: '',
      searchArrivalType: '',
      searchBag: '',
  ...
  computed: {
    filteredList: function filteredList() {
      ...
      return this.desserts.filter(function (item) {
        return String(item.id).includes(_this.searchArrival);
      });
    },
    filteredListArrivalTypes: function filteredListArrivalTypes() {
      var _this2 = this;

      return this.arrivalTypes.filter(function (item) {
        return String(item.id).includes(_this2.searchArrivalType);
      });
    },
    filteredListBags: function filteredListBags() {
      var _this3 = this;

      return this.bags.filter(function (item) {
        return item.name.toLowerCase().match(_this3.searchBag.toLowerCase());
      });
    },
    filteredListCrops: function filteredListCrops() {
      var _this4 = this;

      return this.crops.filter(function (item) {
        return item.name.toLowerCase().match(_this4.searchCrop.toLowerCase());
      });
    },
    filteredListCommodities: function filteredListCommodities() {
      var _this5 = this;

      return this.commodities.filter(function (item) {
        return item.name.toLowerCase().match(_this5.searchCommodity.toLowerCase());
      });
    },
    filteredListCustomers: function filteredListCustomers() {
      var _this6 = this;

      return this.customers.filter(function (item) {
        return item.name.toLowerCase().match(_this6.searchCustomer.toLowerCase());
      });
    },
    filteredListDeals: function filteredListDeals() {
      var _this7 = this;

      return this.deals.filter(function (item) {
        return String(item.id).includes(_this7.searchDeal);
      });
    },
    filteredListDealCommodities: function filteredListDealCommodities() {
      var _this8 = this;

      return this.dealCommodities.filter(function (item) {
        return String(item.id).includes(_this8.searchDealCommodity);
      });
    },
    filteredListDealExpenses: function filteredListDealExpenses() {
      var _this9 = this;

      return this.dealExpenses.filter(function (item) {
        return String(item.id).includes(_this9.searchDealCommodity);
      });
    },
    filteredListExpenses: function filteredListExpenses() {
      var _this10 = this;

      return this.expenses.filter(function (item) {
        return item.name.toLowerCase().match(_this10.searchExpense.toLowerCase());
      });
    },
    filteredListLots: function filteredListLots() {
      var _this11 = this;

      return this.lots.filter(function (item) {
        return item.name.toLowerCase().match(_this11.searchLot.toLowerCase());
      });
    },
    filteredListTemplates: function filteredListTemplates() {
      var _this12 = this;

      return this.templates.filter(function (item) {
        return item.name.toLowerCase().match(_this12.searchTemplate.toLowerCase());
      });
    },
    filteredListTemplateTypes: function filteredListTemplateTypes() {
      var _this13 = this;

      return this.templateTypes.filter(function (item) {
        return String(item.id).includes(_this13.searchTemplateType);
      });
    },
    filteredListUnits: function filteredListUnits() {
      var _this14 = this;

      return this.units.filter(function (item) {
        return item.name.toLowerCase().match(_this14.searchUnit.toLowerCase());
      });
    },
    filteredListUsers: function filteredListUsers() {
      var _this15 = this;

      return this.users.filter(function (item) {
        return item.name.toLowerCase().match(_this15.searchUser.toLowerCase());
      });
    },
    filteredListparentCommodities: function filteredListparentCommodities() {
      var _this16 = this;

      return this.parentCommodities.filter(function (item) {
        return item.name.toLowerCase().match(_this16.searchParentCommodity.toLowerCase());
      });
    }
  },
  ...
  methods: {
    paginateArrivals: function paginateArrivals(e) {
      var _this17 = this;

      console.dir(e);
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-arrivals?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        _this17.desserts = res.data.data;
        _this17.dessertsTotal = res.data.total;
      });
    },
    paginateArrivalTypes: function paginateArrivalTypes(e) {
      var _this18 = this;

      console.dir(e);
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-arrival-types?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        _this18.arrivalTypes = res.data.data;
        _this18.arrivalTypesTotal = res.data.total;
      });
    },
    paginateBags: function paginateBags(e) {
      var _this19 = this;

      console.dir(e);
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-bags?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        _this19.bags = res.data.data;
        _this19.bagsTotal = res.data.total;
      });
    },
    paginateCrops: function paginateCrops(e) {
      var _this20 = this;

      console.dir(e);
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-categories?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        _this20.crops = res.data.data;
        _this20.cropsTotal = res.data.total;
      });
    },
    paginateCommodities: function paginateCommodities(e) {
      var _this21 = this;

      console.dir(e);
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-commodities?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        _this21.commodities = res.data.data;
        _this21.commoditiesTotal = res.data.total;
      });
    },
    paginateCustomers: function paginateCustomers(e) {
      var _this22 = this;

      console.dir(e);
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-customers?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        _this22.customers = res.data.data;
        _this22.customersTotal = res.data.total;
      });
    },
    paginateDeals: function paginateDeals(e) {
      var _this23 = this;

      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-deals?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        _this23.deals = res.data.data;
        _this23.dealsTotal = res.data.total;
      });
    },
    paginateDealCommodities: function paginateDealCommodities(e) {
      var _this24 = this;

      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-deal-commodities?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        _this24.dealCommodities = res.data.data;
        _this24.dealCommoditiesTotal = res.data.total;
      });
    },
    paginateDealExpenses: function paginateDealExpenses(e) {
      var _this25 = this;

      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-deal-expenses?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        _this25.dealExpenses = res.data.data;
        _this25.dealExpensesTotal = res.data.total;
      });
    },
    paginateExpenses: function paginateExpenses(e) {
      var _this26 = this;

      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-expenses?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        _this26.expenses = res.data.data;
        _this26.expensesTotal = res.data.total;
      });
    },
    paginateLots: function paginateLots(e) {
      var _this27 = this;

      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-lots?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        _this27.lots = res.data.data;
        _this27.lotsTotal = res.data.total;
      });
    },
    paginateTemplates: function paginateTemplates(e) {
      var _this28 = this;

      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-templates?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        _this28.templates = res.data.data;
        _this28.templatesTotal = res.data.total;
      });
    },
    paginateTemplateTypes: function paginateTemplateTypes(e) {
      var _this29 = this;

      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-template-types?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        _this29.templateTypes = res.data.data;
        _this29.templateTypesTotal = res.data.total;
      });
    },
    paginateUnits: function paginateUnits(e) {
      var _this30 = this;

      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-units?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        console.log('Units Data: ', res.data);
        _this30.units = res.data.data;
        _this30.unitsTotal = res.data.total;
      });
    },
    paginateUsers: function paginateUsers(e) {
      var _this31 = this;

      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-users?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        console.log('Users Data: ', res.data);
        _this31.users = res.data.data;
        _this31.usersTotal = res.data.total;
      });
    },
    paginateParentCommodities: function paginateParentCommodities(e) {
      var _this32 = this;

      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.get("/api/activity-log/fetch-parent-commodities?page=".concat(e.page, "&per_page=").concat(e.itemsPerPage)).then(function (res) {
        console.log('Users Data: ', res.data);
        _this32.parentCommodities = res.data.data;
        _this32.parentCommoditiesTotal = res.data.total;
      });
    },
    restoreParentCommodity: function restoreParentCommodity(item) {
      var _this33 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-parent-commodity', item).then(function (res) {
            console.log(res);

            _this33.parentCommodities.splice(index, 1);

            _this33.$bvToast.toast(res.data.message, {
    ...
    restoreArrival: function restoreArrival(item) {
      var _this34 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-arrival', item).then(function (res) {
            console.log(res);

            _this34.desserts.splice(index, 1);

            _this34.$bvToast.toast(res.data.message, {
              title: "Record Restored Successfully...",
              solid: true
            });
          });
    ...
    restoreArrivalType: function restoreArrivalType(item) {
      var _this35 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-arrival-type', item).then(function (res) {
            console.log(res);

            _this35.arrivalTypes.splice(index, 1);

            _this35.$bvToast.toast(res.data.message, {
              title: "Record Restored Successfully...",
              solid: true
            });
          });
    ...
    restoreBag: function restoreBag(item) {
      var _this36 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-bag', item).then(function (res) {
            console.log(res);

            _this36.bags.splice(index, 1);

            _this36.$bvToast.toast(res.data.message, {
              title: "Record Restored Successfully...",
              solid: true
            });
          });
    ...
    restoreCategory: function restoreCategory(item) {
      var _this37 = this;

      var index = this.crops.indexOf(item);
      this.itemindex = this.crops.indexOf(item);
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        title: 'Are you sure?',
        text: "You won't be able to revert this!",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-category', item).then(function (res) {
            console.log(res);

            _this37.crops.splice(index, 1);

            _this37.$bvToast.toast(res.data.message, {
              title: "Record Restored Successfully...",
              solid: true
            });
          });
    ...
    restoreCommodity: function restoreCommodity(item) {
      var _this38 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-commodity', item).then(function (res) {
            console.log(res);

            _this38.commodities.splice(index, 1);

            _this38.$bvToast.toast(res.data.message, {
              title: "Record Restored Successfully...",
              solid: true
            });
          });
    ...
    restoreCustomer: function restoreCustomer(item) {
      var _this39 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-customer', item).then(function (res) {
            console.log(res);

            _this39.customers.splice(index, 1);

            _this39.$bvToast.toast(res.data.message, {
              title: "Record Restored Successfully...",
              solid: true
            });
          });
    ...
    restoreDeal: function restoreDeal(item) {
      var _this40 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-deal', item).then(function (res) {
            console.log(res);

            _this40.deals.splice(index, 1);

            _this40.$bvToast.toast(res.data.message, {
              title: "Record Restored Successfully...",
              solid: true
            });
          });
    ...
    restoreDealCommodity: function restoreDealCommodity(item) {
      var _this41 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-deal-commodity', item).then(function (res) {
            console.log(res);

            _this41.dealCommodities.splice(index, 1);

            _this41.$bvToast.toast(res.data.message, {
              title: "Record Restored Successfully...",
              solid: true
            });
          });
    ...
    restoreDealExpense: function restoreDealExpense(item) {
      var _this42 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-deal-expense', item).then(function (res) {
            console.log(res);

            _this42.dealExpenses.splice(index, 1);

            _this42.$bvToast.toast(res.data.message, {
              title: "Record Restored Successfully...",
              solid: true
            });
          });
    ...
    restoreExpense: function restoreExpense(item) {
      var _this43 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-expense', item).then(function (res) {
            console.log(res);

            _this43.expenses.splice(index, 1);

            _this43.$bvToast.toast(res.data.message, {
              title: "Record Restored Successfully...",
              solid: true
            });
          });
    ...
    restoreLot: function restoreLot(item) {
      var _this44 = this;

      var index = this.lots.indexOf(item);
      this.itemindex = this.lots.indexOf(item);
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        title: 'Are you sure?',
        text: "You won't be able to revert this!",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-lot', item).then(function (res) {
            console.log(res);

            _this44.lots.splice(index, 1);

            _this44.$bvToast.toast(res.data.message, {
              title: "Record Restored Successfully...",
              solid: true
            });
          });
    ...
    restoreTemplate: function restoreTemplate(item) {
      var _this45 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-template', item).then(function (res) {
            console.log(res);

            _this45.templates.splice(index, 1);

            _this45.$bvToast.toast(res.data.message, {
              title: "Record Restored Successfully...",
              solid: true
            });
          });
    ...
    restoreTemplateType: function restoreTemplateType(item) {
      var _this46 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-template-type', item).then(function (res) {
            console.log(res);

            _this46.templateTypes.splice(index, 1);

            _this46.$bvToast.toast(res.data.message, {
              title: "Record Restored Successfully...",
              solid: true
            });
          });
    ...
    restoreUnit: function restoreUnit(item) {
      var _this47 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-unit', item).then(function (res) {
            console.log(res);

            _this47.units.splice(index, 1);

            _this47.$bvToast.toast(res.data.message, {
              title: "Record Restored Successfully...",
              solid: true
            });
          });
    ...
    restoreUser: function restoreUser(item) {
      var _this48 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/restore-user', item).then(function (res) {
            console.log(res);

            _this48.users.splice(index, 1);

            _this48.$bvToast.toast(res.data.message, {
              title: "Record Restored Successfully...",
              solid: true
            });
          });
    ...
    deleteParentCommodity: function deleteParentCommodity(item) {
      var _this49 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-parent-commodity', item).then(function (res) {
            console.log(res);

            _this49.parentCommodities.splice(index, 1);

            _this49.$bvToast.toast(res.data.message, {
    ...
    deleteArrival: function deleteArrival(item) {
      var _this50 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-arrival', item).then(function (res) {
            console.log(res);

            _this50.desserts.splice(index, 1);

            _this50.$bvToast.toast(res.data.message, {
              title: "Record Deleted Successfully...",
              solid: true
            });
          });
    ...
    deleteArrivalType: function deleteArrivalType(item) {
      var _this51 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-arrival-type', item).then(function (res) {
            console.log(res);

            _this51.arrivalTypes.splice(index, 1);

            _this51.$bvToast.toast(res.data.message, {
              title: "Record Deleted Successfully...",
              solid: true
            });
          });
    ...
    deleteBag: function deleteBag(item) {
      var _this52 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-bag', item).then(function (res) {
            console.log(res);

            _this52.bags.splice(index, 1);

            _this52.$bvToast.toast(res.data.message, {
              title: "Record Deleted Successfully...",
              solid: true
            });
          });
    ...
    deleteCategory: function deleteCategory(item) {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-category', item).then(function (res) {
            console.log(res);

            _this53.crops.splice(index, 1);

            _this53.$bvToast.toast(res.data.message, {
              title: "Record Deleted Successfully...",
              solid: true
            });
          });
    ...
    deleteCommodity: function deleteCommodity(item) {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-commodity', item).then(function (res) {
            console.log(res);

            _this54.commodities.splice(index, 1);

            _this54.$bvToast.toast(res.data.message, {
              title: "Record Deleted Successfully...",
              solid: true
            });
          });
    ...
    deleteCustomer: function deleteCustomer(item) {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-customer', item).then(function (res) {
            console.log(res);

            _this55.customers.splice(index, 1);

            _this55.$bvToast.toast(res.data.message, {
              title: "Record Deleted Successfully...",
              solid: true
            });
          });
    ...
    deleteDeal: function deleteDeal(item) {
      var _this56 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-deal', item).then(function (res) {
            console.log(res);

            _this56.deals.splice(index, 1);

            _this56.$bvToast.toast(res.data.message, {
              title: "Record Deleted Successfully...",
              solid: true
            });
          });
    ...
    deleteDealCommodity: function deleteDealCommodity(item) {
      var _this57 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-deal-commodity', item).then(function (res) {
            console.log(res);

            _this57.dealCommodities.splice(index, 1);

            _this57.$bvToast.toast(res.data.message, {
              title: "Record Deleted Successfully...",
              solid: true
            });
          });
    ...
    deleteDealExpense: function deleteDealExpense(item) {
      var _this58 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-deal-expense', item).then(function (res) {
            console.log(res);

            _this58.dealExpenses.splice(index, 1);

            _this58.$bvToast.toast(res.data.message, {
              title: "Record Deleted Successfully...",
              solid: true
            });
          });
    ...
    deleteExpense: function deleteExpense(item) {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-expense', item).then(function (res) {
            console.log(res);

            _this59.expenses.splice(index, 1);

            _this59.$bvToast.toast(res.data.message, {
              title: "Record Deleted Successfully...",
              solid: true
            });
          });
    ...
    deleteLot: function deleteLot(item) {
      var _this60 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-lot', item).then(function (res) {
            console.log(res);

            _this60.lots.splice(index, 1);

            _this60.$bvToast.toast(res.data.message, {
              title: "Record Deleted Successfully...",
              solid: true
            });
          });
    ...
    deleteTemplate: function deleteTemplate(item) {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-template', item).then(function (res) {
            console.log(res);

            _this61.templates.splice(index, 1);

            _this61.$bvToast.toast(res.data.message, {
              title: "Record Deleted Successfully...",
              solid: true
            });
          });
    ...
    deleteTemplateType: function deleteTemplateType(item) {
      var _this62 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-template-type', item).then(function (res) {
            console.log(res);

            _this62.templateTypes.splice(index, 1);

            _this62.$bvToast.toast(res.data.message, {
              title: "Record Deleted Successfully...",
              solid: true
            });
          });
    ...
    deleteUnit: function deleteUnit(item) {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-unit', item).then(function (res) {
            console.log(res);

            _this63.units.splice(index, 1);

            _this63.$bvToast.toast(res.data.message, {
              title: "Record Deleted Successfully...",
              solid: true
            });
          });
    ...
    deleteUser: function deleteUser(item) {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__.default.post('/api/activity-log/delete-user', item).then(function (res) {
            console.log(res);

            _this64.users.splice(index, 1);

            _this64.$bvToast.toast(res.data.message, {
              title: "Record Deleted Successfully...",
              solid: true
            });
          });
...
/***/ "./resources/js/src/view/project/activity-log/index.vue":
/*!**************************************************************!*\
  !*** ./resources/js/src/view/project/activity-log/index.vue ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _index_vue_vue_type_template_id_70909da0___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=70909da0& */ "./resources/js/src/view/project/activity-log/index.vue?vue&type=template&id=70909da0&");
/* harmony import */ var _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js& */ "./resources/js/src/view/project/activity-log/index.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  ...
  _index_vue_vue_type_template_id_70909da0___WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_70909da0___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/src/view/project/activity-log/index.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/src/view/project/activity-log/index.vue?vue&type=script&lang=js&":
/*!***************************************************************************************!*\
  !*** ./resources/js/src/view/project/activity-log/index.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/project/activity-log/index.vue?vue&type=script&lang=js&");
...
/***/ "./resources/js/src/view/project/activity-log/index.vue?vue&type=template&id=70909da0&":
/*!*********************************************************************************************!*\
  !*** ./resources/js/src/view/project/activity-log/index.vue?vue&type=template&id=70909da0& ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_70909da0___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_70909da0___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_70909da0___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=70909da0& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/project/activity-log/index.vue?vue&type=template&id=70909da0&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/project/activity-log/index.vue?vue&type=template&id=70909da0&":
/*!************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/project/activity-log/index.vue?vue&type=template&id=70909da0& ***!
  \************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                            ...
                            _c(
                              ...
                              [
                                _c("v-text-field", {
                                  ...
                                  model: {
                                    value: _vm.searchArrival,
                                    callback: function($$v) {
                                      _vm.searchArrival = $$v
                                    },
                                    expression: "searchArrival"
                                  }
                                })
                              ],
                              1
                            ...
                            _c(
                              ...
                              [
                                _c("v-data-table", {
                                  ...
                                  on: { pagination: _vm.paginateArrivals },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                        key: "item.actions",
      ...
      _c(
        ...
        [
           true
            ? _c("KTCard", {
                ref: "preview",
                attrs: { title: _vm.titleArrivalTypes },
                scopedSlots: _vm._u(
                  [
                    {
                      key: "body",
                            ...
                            _c(
                              ...
                              [
                                _c("v-text-field", {
                                  ...
                                  model: {
                                    value: _vm.searchArrivalType,
                                    callback: function($$v) {
                                      _vm.searchArrivalType = $$v
                                    },
                                    expression: "searchArrivalType"
                                  }
                                })
                              ],
                              1
                          ...
                          _c("div", { staticClass: "row" }, [
                            _c(
                              ...
                              [
                                _c("v-data-table", {
                                  attrs: {
                                    headers: _vm.arrivalTypeHeaders,
                                    items: _vm.filteredListArrivalTypes,
                                    search: _vm.searchArrivalType,
                                    "items-per-page": 5,
                                    "footer-props": {
                                      itemsPerPageOptions: [5, 10, 15]
                                    },
                                    "server-items-length": _vm.arrivalTypesTotal
                                  },
                                  on: { pagination: _vm.paginateArrivalTypes },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                        key: "item.actions",
                              ...
                              [
                                _c("v-data-table", {
                                  attrs: {
                                    ...
                                    items: _vm.filteredListBags,
                                    search: _vm.searchBag,
                                    "items-per-page": 5,
                                    "footer-props": {
                                      itemsPerPageOptions: [5, 10, 15]
                                    },
                                    "server-items-length": _vm.bagsTotal
                                  },
                                  on: { pagination: _vm.paginateBags },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                        key: "item.actions",
                            ...
                            _c(
                              ...
                              [
                                _c("v-text-field", {
                                  ...
                                  model: {
                                    value: _vm.searchCrop,
                                    callback: function($$v) {
                                      _vm.searchCrop = $$v
                                    },
                                    expression: "searchCrop"
                                  }
                                })
                              ],
                              1
                          ...
                          _c("div", { staticClass: "row" }, [
                            _c(
                              ...
                              [
                                _c("v-data-table", {
                                  attrs: {
                                    headers: _vm.cropHeaders,
                                    items: _vm.filteredListCrops,
                                    search: _vm.searchCrop,
                                    "items-per-page": 5,
                                    "footer-props": {
                                      itemsPerPageOptions: [5, 10, 15]
                                    },
                                    "server-items-length": _vm.cropsTotal
                                  },
                                  on: { pagination: _vm.paginateCrops },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                        key: "item.actions",
      ...
      _c(
        ...
        [
           true
            ? _c("KTCard", {
                ref: "preview",
                attrs: { title: _vm.titleParentCommodities },
                scopedSlots: _vm._u(
                  [
                    {
                      key: "body",
                            ...
                            _c(
                              ...
                              [
                                _c("v-text-field", {
                                  ...
                                  model: {
                                    value: _vm.searchParentCommodity,
                                    callback: function($$v) {
                                      _vm.searchParentCommodity = $$v
                                    },
                                    expression: "searchParentCommodity"
                                  }
                                })
                              ],
                              1
                          ...
                          _c("div", { staticClass: "row" }, [
                            _c(
                              ...
                              [
                                _c("v-data-table", {
                                  attrs: {
                                    headers: _vm.parentCommodityHeaders,
                                    items: _vm.filteredListparentCommodities,
                                    search: _vm.searchParentCommodity,
                                    "items-per-page": 5,
                                    "footer-props": {
                                      itemsPerPageOptions: [5, 10, 15]
                                    },
                                    "server-items-length":
                                      _vm.parentCommoditiesTotal
                                  },
                                  on: {
                                    pagination: _vm.paginateParentCommodities
                                  },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                          ...
                                          return [
                                            _c(
                                              "v-icon",
                                              {
                                                ...
                                                on: {
                                                  click: function($event) {
                                                    return _vm.restoreParentCommodity(
                                                      item
                                                    )
                                                  }
                                                }
                                            ...
                                            _c(
                                              "v-icon",
                                              {
                                                ...
                                                on: {
                                                  click: function($event) {
                                                    return _vm.deleteParentCommodity(
                                                      item
                                                    )
                                                  }
                                                }
      ...
      _c(
        ...
        [
           true
            ? _c("KTCard", {
                ref: "preview",
                attrs: { title: _vm.titleCommodities },
                scopedSlots: _vm._u(
                  [
                    {
                      key: "body",
                            ...
                            _c(
                              ...
                              [
                                _c("v-text-field", {
                                  ...
                                  model: {
                                    value: _vm.searchCommodity,
                                    callback: function($$v) {
                                      _vm.searchCommodity = $$v
                                    },
                          ...
                          _c("div", { staticClass: "row" }, [
                            _c(
                              ...
                              [
                                _c("v-data-table", {
                                  attrs: {
                                    headers: _vm.commodityHeaders,
                                    items: _vm.filteredListCommodities,
                                    search: _vm.searchCommodity,
                                    "items-per-page": 5,
                                    "footer-props": {
                                      itemsPerPageOptions: [5, 10, 15]
                                    },
                                    "server-items-length": _vm.commoditiesTotal
                                  },
                                  on: { pagination: _vm.paginateCommodities },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                        key: "item.actions",
      ...
      _c(
        ...
        [
           true
            ? _c("KTCard", {
                ref: "preview",
                attrs: { title: _vm.titleCustomers },
                scopedSlots: _vm._u(
                  [
                    {
                      key: "body",
                              ...
                              [
                                _c("v-data-table", {
                                  attrs: {
                                    ...
                                    items: _vm.filteredListCustomers,
                                    search: _vm.searchCustomer,
                                    "items-per-page": 5,
                                    "footer-props": {
                                      itemsPerPageOptions: [5, 10, 15]
                                    },
                                  ...
                                  on: { pagination: _vm.paginateCustomers },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                        key: "item.actions",
                            ...
                            _c(
                              ...
                              [
                                _c("v-text-field", {
                                  ...
                                  model: {
                                    value: _vm.searchDeal,
                                    callback: function($$v) {
                                      _vm.searchDeal = $$v
                                    },
                                    expression: "searchDeal"
                                  }
                                })
                              ],
                              1
                          ...
                          _c("div", { staticClass: "row" }, [
                            _c(
                              ...
                              [
                                _c("v-data-table", {
                                  attrs: {
                                    headers: _vm.dealHeaders,
                                    items: _vm.filteredListDeals,
                                    search: _vm.searchDeal,
                                    "items-per-page": 5,
                                    "footer-props": {
                                      itemsPerPageOptions: [5, 10, 15]
                                    },
                                    "server-items-length": _vm.dealsTotal
                                  },
                                  on: { pagination: _vm.paginateDeals },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                        key: "item.actions",
      ...
      _c(
        ...
        [
           true
            ? _c("KTCard", {
                ref: "preview",
                attrs: { title: _vm.titleDealCommodities },
                scopedSlots: _vm._u(
                  [
                    {
                      key: "body",
                            ...
                            _c(
                              ...
                              [
                                _c("v-text-field", {
                                  ...
                                  model: {
                                    value: _vm.searchDealCommodity,
                                    callback: function($$v) {
                                      _vm.searchDealCommodity = $$v
                                    },
                                    expression: "searchDealCommodity"
                                  }
                                })
                              ],
                              1
                          ...
                          _c("div", { staticClass: "row" }, [
                            _c(
                              ...
                              [
                                _c("v-data-table", {
                                  attrs: {
                                    headers: _vm.dealCommodityHeaders,
                                    items: _vm.filteredListDealCommodities,
                                    search: _vm.searchDealCommodity,
                                    "items-per-page": 5,
                                    "footer-props": {
                                      itemsPerPageOptions: [5, 10, 15]
                                    },
                                    "server-items-length":
                                      _vm.dealCommoditiesTotal
                                  },
                                  on: {
                                    pagination: _vm.paginateDealCommodities
                                  },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                          ...
                                          return [
                                            _c(
                                              "v-icon",
                                              {
                                                ...
                                                on: {
                                                  click: function($event) {
                                                    return _vm.restoreDealCommodity(
                                                      item
                                                    )
                                                  }
                                                }
                                            ...
                                            _c(
                                              "v-icon",
                                              {
                                                ...
                                                on: {
                                                  click: function($event) {
                                                    return _vm.deleteDealCommodity(
                                                      item
                                                    )
                                                  }
                                                }
      ...
      _c(
        ...
        [
           true
            ? _c("KTCard", {
                ref: "preview",
                attrs: { title: _vm.titleDealExpenses },
                scopedSlots: _vm._u(
                  [
                    {
                      key: "body",
                            ...
                            _c(
                              ...
                              [
                                _c("v-text-field", {
                                  ...
                                  model: {
                                    value: _vm.searchDealExpense,
                                    callback: function($$v) {
                                      _vm.searchDealExpense = $$v
                                    },
                                    expression: "searchDealExpense"
                                  }
                                })
                              ],
                              1
                          ...
                          _c("div", { staticClass: "row" }, [
                            _c(
                              ...
                              [
                                _c("v-data-table", {
                                  attrs: {
                                    headers: _vm.dealExpenseHeaders,
                                    items: _vm.filteredListDealExpenses,
                                    search: _vm.searchDealExpense,
                                    "items-per-page": 5,
                                    "footer-props": {
                                      itemsPerPageOptions: [5, 10, 15]
                                    },
                                    "server-items-length": _vm.dealExpensesTotal
                                  },
                                  on: { pagination: _vm.paginateDealExpenses },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                        key: "item.actions",
                            ...
                            _c(
                              ...
                              [
                                _c("v-text-field", {
                                  ...
                                  model: {
                                    value: _vm.searchExpense,
                                    callback: function($$v) {
                                      _vm.searchExpense = $$v
                                    },
                                    expression: "searchExpense"
                                  }
                                })
                              ],
                              1
                              ...
                              [
                                _c("v-data-table", {
                                  attrs: {
                                    ...
                                    items: _vm.filteredListExpenses,
                                    search: _vm.searchExpense,
                                    "items-per-page": 5,
                                    "footer-props": {
                                      itemsPerPageOptions: [5, 10, 15]
                                    },
                                    "server-items-length": _vm.expensesTotal
                                  },
                                  on: { pagination: _vm.paginateExpenses },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                        key: "item.actions",
                          ...
                          _c("div", { staticClass: "row" }, [
                            _c(
                              ...
                              [
                                _c("v-data-table", {
                                  attrs: {
                                    headers: _vm.lotHeaders,
                                    items: _vm.filteredListLots,
                                    search: _vm.searchLot,
                                    "items-per-page": 5,
                                    "footer-props": {
                                      itemsPerPageOptions: [5, 10, 15]
                                    },
                                    "server-items-length": _vm.lotsTotal
                                  },
                                  on: { pagination: _vm.paginateLots },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                        key: "item.actions",
      ...
      _c(
        ...
        [
           true
            ? _c("KTCard", {
                ref: "preview",
                attrs: { title: _vm.titleTemplates },
                scopedSlots: _vm._u(
                  [
                    {
                      key: "body",
                              ...
                              [
                                _c("v-data-table", {
                                  attrs: {
                                    ...
                                    items: _vm.filteredListTemplates,
                                    search: _vm.searchTemplate,
                                    "items-per-page": 5,
                                    "footer-props": {
                                      itemsPerPageOptions: [5, 10, 15]
                                    },
                                    "server-items-length": _vm.templatesTotal
                                  },
                                  on: { pagination: _vm.paginateTemplates },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                        key: "item.actions",
      ...
      _c(
        ...
        [
           true
            ? _c("KTCard", {
                ref: "preview",
                attrs: { title: _vm.titleTemplateTypes },
                scopedSlots: _vm._u(
                  [
                    {
                      key: "body",
                            ...
                            _c(
                              ...
                              [
                                _c("v-text-field", {
                                  ...
                                  model: {
                                    value: _vm.searchTemplateType,
                                    callback: function($$v) {
                                      _vm.searchTemplateType = $$v
                                    },
                                    expression: "searchTemplateType"
                                  }
                                })
                              ],
                              1
                          ...
                          _c("div", { staticClass: "row" }, [
                            _c(
                              ...
                              [
                                _c("v-data-table", {
                                  attrs: {
                                    headers: _vm.templateTypeHeaders,
                                    items: _vm.filteredListTemplateTypes,
                                    search: _vm.searchTemplateType,
                                    "items-per-page": 5,
                                    "footer-props": {
                                      itemsPerPageOptions: [5, 10, 15]
                                    },
                                    "server-items-length":
                                      _vm.templateTypesTotal
                                  },
                                  on: { pagination: _vm.paginateTemplateTypes },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                        key: "item.actions",
                                          ...
                                          return [
                                            _c(
                                              "v-icon",
                                              {
                                                ...
                                                on: {
                                                  click: function($event) {
                                                    return _vm.restoreTemplateType(
                                                      item
                                                    )
                                                  }
                                                }
                          ...
                          _c("div", { staticClass: "row" }, [
                            _c(
                              ...
                              [
                                _c("v-data-table", {
                                  attrs: {
                                    headers: _vm.unitHeaders,
                                    items: _vm.filteredListUnits,
                                    search: _vm.searchUnit,
                                    "items-per-page": 5,
                                    "footer-props": {
                                      itemsPerPageOptions: [5, 10, 15]
                                    },
                                    "server-items-length": _vm.unitsTotal
                                  },
                                  on: { pagination: _vm.paginateUnits },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                        key: "item.actions",
                            ...
                            _c(
                              ...
                              [
                                _c("v-data-table", {
                                  ...
                                  on: { pagination: _vm.paginateUsers },
                                  scopedSlots: _vm._u(
                                    [
                                      {
                                        key: "item.actions",
