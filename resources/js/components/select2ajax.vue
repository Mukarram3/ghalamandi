<template>
    <select id="select2ajax-template-purchase" class="form-control select2ajax-template-purchase" style="width: 100%">
    </select>
</template>
...
<script>
    export default {
        ...
        template: '#select2ajax-template-purchase',
        mounted: function() {
            var vm = this;
            $(this.$el)
                // init select2
                .select2({
                    ajax: {
                        url: "/api/purchase-deal/fetch-commodities",
