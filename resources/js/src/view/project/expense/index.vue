                ...
                <KTCard ref="preview" v-if="true" v-bind:title="titleRight" >
                    ...
                    <template v-slot:toolbar>
                        <div class="example-tools justify-content-center">
                            <router-link to="/expense/create" class="btn btn-dark btn-sm">Create</router-link>
                        </div>
                    </template>
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                ...
                headers: [
                    ...
                    { text: 'Expense Head', value: 'expense.name' },
        ...
        methods: {
            ...
            editItem(item){
                this.$router.push({name: 'edit_expense', params: {id: item.id}});
            },
            deleteItem(item){
