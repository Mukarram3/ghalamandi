...
<!--                                                <router-link to="/sale-invoice/create" class="btn btn-dark btn-sm">Create</router-link>-->
...
export default {
    ...
    methods: {
        ...
        gatePassGenerate(item) {
            this.$router.push({name: 'gate-pass-sale', params: {id: item.id}});
        },
        invoiceGenerate(item) {
            this.$router.push({name: 'invoice_sale', params: {id: item.id}});
        },
        // getDataFromApi() {
        //     var respoData = [];
        ...
        editItem(item) {
            ...
            this.is_update = true;
            this.$router.push({name: 'edit_invoice_sale', params: {id: this.edit_id}});
