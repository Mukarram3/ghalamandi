                            ...
                            <b-form @submit="onSubmit" @reset="onReset" v-if="show">
                                ...
                                >
                                    <select class="form-control" v-model="form.parent_id">
                                        <option value="" disabled hidden>Choose Parent Commodity</option>
                                        <option v-for="option in parents" :value="option.id">{{
                                                option.name
                                            }}
                                        </option>
                                    </select>
                                    <b-form-invalid-feedback style="display: block;" v-if="errors.parent_id"
                                                             :errors="errors">
                                        <span v-for="error in errors.parent_id ">{{ error }}</span><br>
                                    </b-form-invalid-feedback>
...
export default {
    ...
    methods: {
        ...
        redirectToIndex() {
            this.$router.push({name: 'index_commodity'});
        },
        onReset(evt) {
            evt.preventDefault()
        ...
        getParents() {
            ApiService.get('/api/commodity/fetch-parent-commodities').then((res) => {
        ...
        getLast() {
            ApiService.get('/api/commodity/last').then((res) => {
