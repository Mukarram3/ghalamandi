                ...
                <KTCard ref="preview" v-bind:title="titleRight">
                    ...
                    <template v-slot:toolbar>
                        <div class="example-tools justify-content-center">
                            <router-link to="/commodity/create" class="btn btn-dark btn-sm">Create</router-link>
                        </div>
                    </template>
...
export default {
    ...
    data() {
        return {
            ...
            headers: [
                ...
                {text: 'Default Unit', value: 'unit.name'},
                {text: 'Bag Type', value: 'bag.name'},
    ...
    methods: {
        ...
        editItem(item) {
            this.$router.push({name: 'edit_commodity', params: {id: item.id}});
        },
        deleteItem(item) {
