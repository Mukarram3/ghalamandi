                    ...
                    <template v-slot:body>
                        <div>
                            <b-form @submit="onSubmit" @reset="onReset" v-if="show">
                                ...
                                <b-form-group id="input-group-2" label="Code :" label-for="input32">
                                    <b-form-input
                                        id="input-3"
                                        v-model="form.code"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            {
                console.dir(e);
                ApiService.get(`/api/category/fetch?page=${e.page}&per_page=${e.itemsPerPage}`)
                    .then((res) => {
            ...
            // getDataFromApi(){
            //     var respoData=[];
            //     ApiService.get('/api/category/fetch').then((res)=>{
            ...
            deleteItem(item){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        ApiService.post('/api/category/delete',item).then((res)=>{
                            console.log(res)
