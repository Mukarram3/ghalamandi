                        ...
                        <div>
                            <b-form @submit="onSubmit" @reset="onReset" v-if="show">
                                <b-form-group id="input-group3" label="Account :" label-for="input3">
                                    ...
                                    <b-form-invalid-feedback style="display: block;" v-if="errors.deduction_id"
                                                             :errors="errors">
...
export default {
    ...
    methods: {
        ...
        onSubmit(evt) {
            ...
            ApiService.post('/api/deduction-item/update', this.form).then((res) => {
        ...
        getEditDataFromApi: function () {
            ApiService.get('/api/deduction-item/edit', this.$route.params.id).then((res) => {
                this.form = res.data;
            });
        },
