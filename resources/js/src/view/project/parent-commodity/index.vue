                ...
                <KTCard ref="preview" v-bind:title="titleRight">
                    ...
                    <template v-slot:toolbar>
                        <div class="example-tools justify-content-center">
                            <router-link to="/parent-commodity/create" class="btn btn-dark btn-sm">Create</router-link>
                        </div>
                    </template>
...
export default {
    ...
    methods: {
        paginate(e) {
            console.dir(e);
            ApiService.get(`/api/parent-commodity/fetch?page=${e.page}&per_page=${e.itemsPerPage}`)
                .then((res) => {
        ...
        editItem(item) {
            this.$router.push({name: 'edit_parent_commodity', params: {id: item.id}});
        },
        deleteItem(item) {
