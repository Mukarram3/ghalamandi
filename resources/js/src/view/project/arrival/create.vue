...
export default {
    ...
    data() {
        return {
            ...
            headers: [
                ...
                {text: 'Supplier', value: 'customer_id'},
                ...
                // {text: 'Deduction Weight', value: 'deduction_weight'},
    ...
    beforeMount() {
        ...
        this.columnDefs = [
            ...
            {headerName: 'Supplier', field: 'customer_id'},
            ...
            // {headerName: 'Deduction Weight', field: 'deduction_weight'},
    ...
    methods: {
        calulateTotals() {
            ...
            console.log('Total Weight: ', arrivalWeight, this.form.total_weight);
        ...
        getLast() {
            ApiService.get('/api/arrival/last').then((res) => {
                this.form.arrival_id = res.data;
                console.log('Last: ', this.form.arrival_id);
            });
        },
        currentDateTime() {
            ...
            this.form.arrival_date = date +' '+ time;
        }
    },
    created() {
        this.getLast();
