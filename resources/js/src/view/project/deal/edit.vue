...
export default {
    ...
    methods: {
        ...
        redirect() {
            this.$router.push({name: 'index_deal_purchase'});
        },
        onSubmit: function (evt) {
            ...
            ApiService.post('/api/purchase-deal/update', this.form, this.desserts).then((res) => {
                // console.log(res)
        ...
        deleteItem(item) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    ApiService.post('/api/purchase-deal/delete-deal-commodity',item).then((res)=>{
                        // console.log(res)
        ...
        getEditDataFromApi: function () {
            ApiService.get('/api/purchase-deal/edit', this.$route.params.id).then((res) => {
