                        ...
                        <div>
                            ...
                            <b-row>
                                ...
                                <b-col md="3">
                                    ...
                                    <div role="group">
                                        <select2 class="form-control" :options="parties" v-bind:value="form.customer_id" v-model="form.customer_id"></select2>
                                ...
                                <b-col md="3">
                                    ...
                                    <div role="group">
                                        <select2 class="form-control" :options="brokers" :value="form.broker_id" v-model="form.broker_id">
                            ...
                            <b-row>
                                <b-col md="4">
                                    ...
                                    <select2ajax v-on:selectMyEvent="focusQuantity" ref="select2ajax" class="form-control" style="line-height: 0px !important;" v-model="form.selectedAjax"
...
<!--                                            </v-icon>-->
                            ...
                            <b-row>
                                <b-col md="12">
                                    <b-button @click="onSubmit" type="submit" variant="primary" v-html="submit_text">Save & Add New</b-button>
...
export default {
    ...
    methods: {
        ...
        addCart: function (event) {
            ...
            this.row++;
            var commodity = $('.select2ajax-template-purchase').select2('data')[0];
            // console.log('AddCart: ', );
        ...
        onSubmit: function (evt) {
            ...
            ApiService.post('/api/purchase-deal/create', this.form).then((res) => {
        ...
        getTemplateDataFromApi() {
            ApiService.get('/api/purchase-deal/fetch-templates').then((res) => {
        ...
        getPartyDataFromApi() {
            this.parties=[];
            ApiService.get('/api/purchase-deal/fetch-parties').then((res) => {
                // console.log('Parties: ', res.data);
                this.parties = res.data;
            });
        },
        getBrokerDataFromApi() {
            ApiService.get('/api/purchase-deal/fetch-brokers').then((res) => {
                this.brokers = res.data;
            });
        },
        getUnitDataFromApi() {
            ApiService.get('/api/purchase-deal/fetch-units').then((res) => {
                // console.log('Units: ', res.data);
                // this.units = res.data;
                $.each(res.data,(index,value)=>{
                    this.units.push({id:value.id,text:value.text,selected:(value.is_default=='yes'?true:false)});
                })
            });
        },
        getCommodityDataFromApi() {
            ApiService.get('/api/purchase-deal/fetch-commodities').then((res) => {
        ...
        getLast() {
            ApiService.get('/api/deal/last').then((res) => {
                this.form.du_id = res.data;
            });
        },
        currentDateTime() {
